...
(
    ...
    `OrderQuantityInDeliveryUnit`                       float(15) DEFAULT NULL,
    ...
    CONSTRAINT `DPFMContractItemDataProductWeightUnit_fk` FOREIGN KEY (`ProductWeightUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
    ...
    CONSTRAINT `DPFMContractItemDataInspectionPlant_fk` FOREIGN KEY (`InspectionPlant`) REFERENCES `data_platform_plant_general_data` (`Plant`),
